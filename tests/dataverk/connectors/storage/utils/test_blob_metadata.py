...
from tests.dataverk.connectors.storage.test_resources.google_storage_common import GCS_BUCKET_NAME, \
    EXPECTED_BLOB_METADATA_MARKDOWN, EXPECTED_BLOB_METADATA_OBJECT
from tests.dataverk.connectors.storage.test_resources.mock_google_cloud_api import MockBucket
